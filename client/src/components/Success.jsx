  ...
  return (
    <div className="fixed top-0 bottom-0 right-0 left-0 flex items-center justify-center z-50 bg-black bg-opacity-50">  
        <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Payment Successful</p>
                <button onClick={handleSubmit} data-modal-toggle="successModal" type="button" className="py-2 px-3 text-sm font-medium text-center text-white rounded-lg bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-900">Continue</button>
            </div>
        </div>
    </div>
  )
